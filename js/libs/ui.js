...
UI.Tr.prototype = Object.create( UI.Element.prototype );
UI.Tr.prototype.constructor = UI.Tr;
...
UI.Td.prototype = Object.create( UI.Element.prototype );
UI.Td.prototype.constructor = UI.Td;
...
UI.Input = function ( text ) {
	...
	dom.className = 'Input';
	dom.style.border = '0px solid transparent';
...
UI.createDiv=function(className,parent,content,type){
	...
	if(content) obj.setTextContent(content);
	parent.add(obj);
	return obj;
};